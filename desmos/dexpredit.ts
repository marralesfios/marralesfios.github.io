import { copy_snippet, Expression, Line, paste_snippet } from "./libdesmos.js";
...
const wsp_element = document.getElementById("workspace") as HTMLDivElement;

const DESMOS_COLORS: readonly string[] = [
    "#c74440",
    "#2d70b3",
    "#348543",
    "#fa7e19",
...
function mktextarea(init: string=""): HTMLTextAreaElement{
...
function render_line(ln: Line): HTMLDivElement{
...
(document.getElementById("paste") as HTMLButtonElement).addEventListener("click",async () => {
